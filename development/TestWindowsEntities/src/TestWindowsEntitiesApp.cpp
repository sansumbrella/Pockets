...
#include "pockets/puptent/ParticleBehaviorSystems.h"
...
class TestWindowsEntitiesApp : public AppNative
{
public:
...
void TestWindowsEntitiesApp::prepareSettings( Settings *settings )
{
...
void TestWindowsEntitiesApp::setup()
{
...
Entity TestWindowsEntitiesApp::createPlanet()
{
...
Entity TestWindowsEntitiesApp::createShip()
{
...
Entity TestWindowsEntitiesApp::createRibbon()
{
	Entity e = mEntities->create();
...
Entity TestWindowsEntitiesApp::createLine()
{
	Entity e = mEntities->create();
	auto loc = e.assign<Locus>();
...
Entity TestWindowsEntitiesApp::createPlayer()
{
	Rand r;
...
Entity TestWindowsEntitiesApp::createTreasure()
{
...
void TestWindowsEntitiesApp::update()
{
...
void TestWindowsEntitiesApp::draw()
{
...
CINDER_APP_NATIVE( TestWindowsEntitiesApp, RendererGl( RendererGl::Options().antiAliasing( RendererGl::AA_MSAA_4 ) ) )
